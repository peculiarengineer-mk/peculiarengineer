...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <g>
    ...
    <text x="1066" y="77" font-family="${mono}" font-size="20" letter-spacing="2" fill="${bright}">&#9670; NETPLAN &#183; 26.04</text>
  </g>
  ...
  <!-- right column: the 26.04 convergence -->
  <g font-family="${mono}">
    <text x="852" y="200" font-size="20" letter-spacing="2" fill="${dim}">ONE FILE, EITHER BOX</text>

    <rect x="852" y="220" width="456" height="178" rx="8" fill="none" stroke="${bright}" stroke-width="2"/>
    <text x="880" y="266" font-size="19" fill="${accent}">server  &#8594; you edit the YAML</text>
    <text x="880" y="302" font-size="19" fill="${accent}">desktop &#8594; GUI writes it for you</text>
    <text x="880" y="344" font-size="18" fill="${bright}">  both land in /etc/netplan/</text>
    <text x="880" y="378" font-size="16.5" fill="${dim}">90-NM-&lt;uuid&gt;.yaml on desktop</text>

    <text x="852" y="452" font-size="18" fill="${accent}"><tspan fill="#e5534b">gateway4</tspan>  deprecated &#183; use routes:</text>
    ...
    <text x="852" y="552" font-size="17" fill="${dim}">netplan is the single source of truth</text>
  </g>
</svg>`;

writeFileSync(new URL('../src/assets/.static-ip-2604-hero.svg', import.meta.url), svg);

await sharp(Buffer.from(svg), { density: 144 })
  .resize(W * 2, H * 2)
  .png()
  .toFile(new URL('../src/assets/static-ip-2604-hero.png', import.meta.url).pathname);

console.log('wrote src/assets/static-ip-2604-hero.png');
